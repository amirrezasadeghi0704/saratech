...
float shift = 0;
float ballangle = 0;
float ballangle_filtered = 0;
float balldistance;
bool isball;
int min_speed = 32000, max_speed = 50000;
...
void loop() {
  ...
  if (isball) {
    shift = clamp(ballangle_filtered * 1.100, -60.000, 60.000);
